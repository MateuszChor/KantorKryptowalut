...
from src.dirtectory_operator import BG_CHILD_WINDOW, EXIT_BUTTON_IMG, WALLET_BG, BUY_IMG, BGBG
...
class WalletWindow(ChildWindow):
    def __init__(self, master_window):
        ...
        self.label_owner1 = tk.Label(self.child_window,
                              ...
                              font="none 10 bold",
                              anchor=tk.CENTER)
        self.label_owner1.place(x=250, y=40)
        ...
        self.label_PLN1 = tk.Label(self.child_window,
                              ...
                              font="none 10 bold",
                              anchor=tk.CENTER)
        self.label_PLN1.place(x=250, y=80)
        ...
        self.label_PLN1 = tk.Label(self.child_window,
                                   ...
                                   font="none 10 bold",
                                   anchor=tk.CENTER)
        self.label_PLN1.place(x=50, y=80)
        ...
        self.label_EUR1 = tk.Label(self.child_window,
                                  ...
                                  font="none 10 bold",
                                  anchor=tk.CENTER)
        self.label_EUR1.place(x=250, y=120)
        ...
        self.label_BTC1 = tk.Label(self.child_window,
                                  ...
                                  font="none 10 bold",
                                  anchor=tk.CENTER)
        self.label_BTC1.place(x=250, y=160)
        ...
        self.label_ETH1 = tk.Label(self.child_window,
                                  ...
                                  font="none 10 bold",
                                  anchor=tk.CENTER)
        self.label_ETH1.place(x=250, y=200)
        ...
        self.buy_button.place(x=300, y=150)
